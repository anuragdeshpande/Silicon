 ...
 * 
 */
@WebServiceClient(name = "MaintenanceToolsAPI", targetNamespace = "http://guidewire.com/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI", wsdlLocation = "http://ab8dev/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MAINTENANCETOOLSAPI_QNAME = new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI", "MaintenanceToolsAPI");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ab8dev/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI?WSDL");
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port() {
        return super.getPort(new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class);
    }
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port(WebServiceFeature... features) {
        return super.getPort(new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab1000/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class, features);
    }

 ...
 * 2021-05-03T11:44:55.620-06:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "MaintenanceToolsAPI",
                  wsdlLocation = "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/maintenanceToolsAPI/bc/BCMaintenance.wsdl",
                  targetNamespace = "http://guidewire.com/bc/ws/gw/webservice/bc/MaintenanceToolsAPI")
public class MaintenanceToolsAPI extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://guidewire.com/bc/ws/gw/webservice/bc/MaintenanceToolsAPI", "MaintenanceToolsAPI");
    public final static QName MaintenanceToolsAPISoap11Port = new QName("http://guidewire.com/bc/ws/gw/webservice/bc/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port");
    public final static QName MaintenanceToolsAPISoap12Port = new QName("http://guidewire.com/bc/ws/gw/webservice/bc/MaintenanceToolsAPI", "MaintenanceToolsAPISoap12Port");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/maintenanceToolsAPI/bc/BCMaintenance.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MaintenanceToolsAPI.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/maintenanceToolsAPI/bc/BCMaintenance.wsdl");
        }
        WSDL_LOCATION = url;
    }

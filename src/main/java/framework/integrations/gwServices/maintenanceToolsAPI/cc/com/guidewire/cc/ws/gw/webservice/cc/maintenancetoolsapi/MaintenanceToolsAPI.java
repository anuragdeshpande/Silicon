 ...
 * 
 */
@WebServiceClient(name = "MaintenanceToolsAPI", targetNamespace = "http://guidewire.com/cc/ws/gw/webservice/cc/MaintenanceToolsAPI", wsdlLocation = "http://cc8dev/cc/ws/gw/webservice/cc/MaintenanceToolsAPI?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MAINTENANCETOOLSAPI_QNAME = new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MaintenanceToolsAPI", "MaintenanceToolsAPI");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://cc8dev/cc/ws/gw/webservice/cc/MaintenanceToolsAPI?WSDL");
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port() {
        return super.getPort(new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class);
    }
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port(WebServiceFeature... features) {
        return super.getPort(new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "MaintenanceToolsAPI", targetNamespace = "http://guidewire.com/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI", wsdlLocation = "http://pc8dev/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MAINTENANCETOOLSAPI_QNAME = new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI", "MaintenanceToolsAPI");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://pc8dev/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI?WSDL");
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port() {
        return super.getPort(new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class);
    }
    ...
    public MaintenanceToolsAPIPortType getMaintenanceToolsAPISoap11Port(WebServiceFeature... features) {
        return super.getPort(new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc800/MaintenanceToolsAPI", "MaintenanceToolsAPISoap11Port"), MaintenanceToolsAPIPortType.class, features);
    }

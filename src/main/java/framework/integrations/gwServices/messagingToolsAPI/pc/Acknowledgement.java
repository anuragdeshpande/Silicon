...
@XmlType(name = "Acknowledgement", namespace = "http://guidewire.com/gw/api/webservice/messagingTools", propOrder = {
    "ackCode",
    "customEvents",
    "duplicate",
    "error",
...
public class Acknowledgement {
    ...
    public static class CustomEvents {
        ...
        protected List<framework.integrations.gwServices.messagingToolsAPI.pc.CustomEvents> entry;
         ...
         * {@link framework.integrations.gwServices.messagingToolsAPI.pc.CustomEvents }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.pc.CustomEvents> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.pc.CustomEvents>();
            }
            return this.entry;
        }
    ...
    public static class FieldChanges {
        ...
        @XmlElement(name = "Entry", namespace = "http://guidewire.com/gw/api/webservice/messagingTools", nillable = true)
        protected List<framework.integrations.gwServices.messagingToolsAPI.pc.FieldChanges> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link framework.integrations.gwServices.messagingToolsAPI.pc.FieldChanges }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.pc.FieldChanges> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.pc.FieldChanges>();
            }
            return this.entry;
        }

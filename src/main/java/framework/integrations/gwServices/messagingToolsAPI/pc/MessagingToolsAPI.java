 ...
 * 2021-06-14T13:59:44.113-06:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "MessagingToolsAPI",
                  wsdlLocation = "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/pc/MessagingTools.wsdl",
                  targetNamespace = "http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/MessagingToolsAPI")
public class MessagingToolsAPI extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/MessagingToolsAPI", "MessagingToolsAPI");
    public final static QName MessagingToolsAPISoap12Port = new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/MessagingToolsAPI", "MessagingToolsAPISoap12Port");
    public final static QName MessagingToolsAPISoap11Port = new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/MessagingToolsAPI", "MessagingToolsAPISoap11Port");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/pc/MessagingTools.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessagingToolsAPI.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/pc/MessagingTools.wsdl");
        }
        WSDL_LOCATION = url;
    }

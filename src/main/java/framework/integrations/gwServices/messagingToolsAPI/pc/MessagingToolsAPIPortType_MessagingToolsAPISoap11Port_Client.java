 ...
 * 2021-06-14T13:59:44.052-06:00
 * Generated source version: 3.3.4
 *
 */
public final class MessagingToolsAPIPortType_MessagingToolsAPISoap11Port_Client {

    private static final QName SERVICE_NAME = new QName("http://guidewire.com/pc/ws/gw/webservice/pc/pc1000/MessagingToolsAPI", "MessagingToolsAPI");
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.MessageProcessingDirection _resumeDestination_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.MessageProcessingDirection _isSuspended_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.MessageProcessingDirection _suspendDestination_direction = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.pc.MessageStatisticsData _getTotalStatistics__return = port.getTotalStatistics(_getTotalStatistics_destID);
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.pc.MessageStatisticsData _getMessageStatisticsForSafeOrderedObject__return = port.getMessageStatisticsForSafeOrderedObject(_getMessageStatisticsForSafeOrderedObject_destID, _getMessageStatisticsForSafeOrderedObject_safeOrderedObjectId);
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.Acknowledgement _ackMessage_ack = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.pc.ExternalDestinationConfig _getConfiguration__return = port.getConfiguration(_getConfiguration_destID);
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.MessageProcessingDirection _isResumed_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.pc.ErrorCategory _retryRetryableErrorMessagesForCategory_category = null;
        try {
        ...
        java.lang.String _resyncAccount_accountNumber = "";
        try {
            port.resyncAccount(_resyncAccount_destID, _resyncAccount_accountNumber);

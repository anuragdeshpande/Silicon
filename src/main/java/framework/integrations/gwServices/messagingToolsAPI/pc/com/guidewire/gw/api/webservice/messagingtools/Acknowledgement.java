...
public class Acknowledgement {
    ...
    public static class CustomEvents {
        ...
        protected List<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.CustomEvents> entry;
         ...
         * {@link framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.CustomEvents }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.CustomEvents> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.CustomEvents>();
            }
            return this.entry;
        }
    ...
    public static class FieldChanges {
        ...
        @XmlElement(name = "Entry", nillable = true)
        protected List<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.FieldChanges> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.FieldChanges }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.FieldChanges> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.pc.com.guidewire.gw.api.webservice.messagingtools.FieldChanges>();
            }
            return this.entry;
        }

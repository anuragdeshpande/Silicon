 ...
 * 
 */
@WebFault(name = "IllegalArgumentException", targetNamespace = "http://guidewire.com/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI")
    ...
    extends Exception
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6526637959735603584L;
	/**
     ...
     * 
     * @return
     *     returns fault bean: framework.integrations.gwServices.messagingToolsAPI.ab.com.guidewire.ab.ws.gw.webservice.ab.ab801.messagingtoolsapi.IllegalArgumentException
     */

 ...
 * 
 */
@WebServiceClient(name = "MessagingToolsAPI", targetNamespace = "http://guidewire.com/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI", wsdlLocation = "http://ab8uat/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI?WSDL")
    ...
    extends Service
{
    ...
    private final static QName MESSAGINGTOOLSAPI_QNAME = new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI", "MessagingToolsAPI");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ab8uat/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI?WSDL");
    ...
    public MessagingToolsAPIPortType getMessagingToolsAPISoap11Port() {
        return super.getPort(new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI", "MessagingToolsAPISoap11Port"), MessagingToolsAPIPortType.class);
    }
    ...
    public MessagingToolsAPIPortType getMessagingToolsAPISoap11Port(WebServiceFeature... features) {
        return super.getPort(new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab801/MessagingToolsAPI", "MessagingToolsAPISoap11Port"), MessagingToolsAPIPortType.class, features);
    }

 ...
 * 2021-04-09T10:43:18.825-06:00
 * Generated source version: 3.3.4
 *
 */
public final class MessagingToolsAPIPortType_MessagingToolsAPISoap11Port_Client {

    private static final QName SERVICE_NAME = new QName("http://guidewire.com/ab/ws/gw/webservice/ab/ab1000/MessagingToolsAPI", "MessagingToolsAPI");
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        framework.integrations.gwServices.messagingToolsAPI.ab.MessageProcessingDirection _isSuspended_direction = null;
        try {
        ...
        {
        System.out.println("Invoking resyncABContact...");
        int _resyncABContact_destID = 0;
        java.lang.String _resyncABContact_abcontactID = "";
        try {
            port.resyncABContact(_resyncABContact_destID, _resyncABContact_abcontactID);
        ...
        framework.integrations.gwServices.messagingToolsAPI.ab.MessageProcessingDirection _suspendDestination_direction = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.ab.MessageStatisticsData _getTotalStatistics__return = port.getTotalStatistics(_getTotalStatistics_destID);
        ...
        framework.integrations.gwServices.messagingToolsAPI.ab.MessageProcessingDirection _resumeDestination_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.ab.Acknowledgement _ackMessage_ack = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.ab.ExternalDestinationConfig _getConfiguration__return = port.getConfiguration(_getConfiguration_destID);
        ...
        framework.integrations.gwServices.messagingToolsAPI.ab.MessageProcessingDirection _isResumed_direction = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.ab.MessageStatisticsData _getMessageStatisticsForSafeOrderedObject__return = port.getMessageStatisticsForSafeOrderedObject(_getMessageStatisticsForSafeOrderedObject_destID, _getMessageStatisticsForSafeOrderedObject_safeOrderedObjectId);

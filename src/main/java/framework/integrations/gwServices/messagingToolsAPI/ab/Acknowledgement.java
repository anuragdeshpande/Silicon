...
public class Acknowledgement {
    ...
    public static class CustomEvents {
        ...
        protected List<framework.integrations.gwServices.messagingToolsAPI.ab.CustomEvents> entry;
         ...
         * {@link framework.integrations.gwServices.messagingToolsAPI.ab.CustomEvents }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.ab.CustomEvents> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.ab.CustomEvents>();
            }
            return this.entry;
        }
    ...
    public static class FieldChanges {
        ...
        @XmlElement(name = "Entry", namespace = "http://guidewire.com/gw/api/webservice/messagingTools", nillable = true)
        protected List<framework.integrations.gwServices.messagingToolsAPI.ab.FieldChanges> entry;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link framework.integrations.gwServices.messagingToolsAPI.ab.FieldChanges }
         * 
         * 
         */
        public List<framework.integrations.gwServices.messagingToolsAPI.ab.FieldChanges> getEntry() {
            if (entry == null) {
                entry = new ArrayList<framework.integrations.gwServices.messagingToolsAPI.ab.FieldChanges>();
            }
            return this.entry;
        }

 ...
 * 2021-04-09T10:41:08.317-06:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "MessagingToolsAPI",
                  wsdlLocation = "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/cc/CC10Messaging.wsdl",
                  targetNamespace = "http://guidewire.com/cc/ws/gw/webservice/cc/MessagingToolsAPI")
public class MessagingToolsAPI extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MessagingToolsAPI", "MessagingToolsAPI");
    public final static QName MessagingToolsAPISoap12Port = new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MessagingToolsAPI", "MessagingToolsAPISoap12Port");
    public final static QName MessagingToolsAPISoap11Port = new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MessagingToolsAPI", "MessagingToolsAPISoap11Port");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/cc/CC10Messaging.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MessagingToolsAPI.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Work/IntellijProjects/Silicon/src/main/java/framework/integrations/gwServices/messagingToolsAPI/cc/CC10Messaging.wsdl");
        }
        WSDL_LOCATION = url;
    }

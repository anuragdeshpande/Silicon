 ...
 * 2021-04-09T10:41:08.277-06:00
 * Generated source version: 3.3.4
 *
 */
public final class MessagingToolsAPIPortType_MessagingToolsAPISoap11Port_Client {

    private static final QName SERVICE_NAME = new QName("http://guidewire.com/cc/ws/gw/webservice/cc/MessagingToolsAPI", "MessagingToolsAPI");
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        framework.integrations.gwServices.messagingToolsAPI.cc.MessageProcessingDirection _suspendDestination_direction = null;
        try {
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.cc.MessageStatisticsData _getTotalStatistics__return = port.getTotalStatistics(_getTotalStatistics_destID);
        ...
        framework.integrations.gwServices.messagingToolsAPI.cc.MessageProcessingDirection _isSuspended_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.cc.MessageProcessingDirection _resumeDestination_direction = null;
        try {
        ...
        {
        System.out.println("Invoking getMessageId...");
        java.lang.String _getMessageId_senderRefID = "";
        int _getMessageId_destID = 0;
        try {
            long _getMessageId__return = port.getMessageId(_getMessageId_senderRefID, _getMessageId_destID);
            System.out.println("getMessageId.result=" + _getMessageId__return);
        ...
        framework.integrations.gwServices.messagingToolsAPI.cc.MessageProcessingDirection _isResumed_direction = null;
        try {
        ...
        framework.integrations.gwServices.messagingToolsAPI.cc.Acknowledgement _ackMessage_ack = null;
        try {
        ...
        {
        System.out.println("Invoking resyncClaim...");
        int _resyncClaim_destID = 0;
        java.lang.String _resyncClaim_claimID = "";
        try {
            port.resyncClaim(_resyncClaim_destID, _resyncClaim_claimID);
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.cc.ExternalDestinationConfig _getConfiguration__return = port.getConfiguration(_getConfiguration_destID);
        ...
        try {
            framework.integrations.gwServices.messagingToolsAPI.cc.MessageStatisticsData _getMessageStatisticsForSafeOrderedObject__return = port.getMessageStatisticsForSafeOrderedObject(_getMessageStatisticsForSafeOrderedObject_destID, _getMessageStatisticsForSafeOrderedObject_safeOrderedObjectId);

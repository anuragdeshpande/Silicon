...
public class PortalEnvironment extends GenericEnvironment {
    ...
    public static PortalEnvironment DEV10 = new PortalEnvironment("http://fbmsdkr-dev1.idfbins.com/amp/html/#/auth/login", Environments.DEV, new DBConnectionDTO("fbmsdkr-dev1.idfbins.com:3308", "uaa", "password", ""));

 ...
 *     4. Can store only 5MB of data in totality
     ...
     * @param value value associated with the key
     */
    public static synchronized void storeData(String key, String value){
        ((JavascriptExecutor) BrowserFactory.getCurrentBrowser().getDriver()).executeScript("window.localStorage.setItem('"+ key+"', '"+value+"')");
    }
